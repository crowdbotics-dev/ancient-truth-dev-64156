"""
Django settings for ancient_truth_dev_64156 project.
...
ROOT_URLCONF = 'ancient_truth_dev_64156.urls'
...
WSGI_APPLICATION = 'ancient_truth_dev_64156.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "ancient_truth_dev_64156 API",
    "DESCRIPTION": "API documentation for ancient_truth_dev_64156 App",
    "VERSION": "v1",
}
